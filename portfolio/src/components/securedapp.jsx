        ...
        <div className="" style={BackGround}>
            ...
            <div className=" m-6 p-10 rounded-3xl md:m-10 lg:m-16"style={combinedStyles}>
                <div className=" pl-1 space-y-1 md:pl-6 lg:pl-10" >
                    ...
                    <p className=' text-xl  orbitron-font md:text-2xl'>**Frontend Developer & Growth Hacks** </p>
                    <p className=' text-xl  orbitron-font md:text-2xl '>*<span className=' font-semibold'>Duration:</span> July 10, 2023 - September 24, 2023*</p>
                </div>
                ...
                <div className="pl-1 pt-10 space-y-1 md:pl-6 lg:pl-10">
                    ...
                    <p className=' text-xl kaushan-font tracking-wide md:text-2xl'>
                ...
                <div className="pl-1 pt-10 space-y-1 md:pl-6 lg:pl-10">
                    ...
                    <p className=' text-xl kaushan-font tracking-wide md:text-2xl'>My internship at SecureDApp allowed me to develop both technical and soft skills. I enhanced my proficiency in frontend development, gained experience in growth hacking, and improved my ability to collaborate in a dynamic team environment. I also learned the importance of data-driven decision-making and the value of user-centric design.</p>
                </div>
            </div>
